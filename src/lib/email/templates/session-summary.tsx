...
export function SessionSummaryEmail({
  ...
  return (
    <EmailLayout footerText={labels.footer} companyName={companyName} companyColor={companyColor}>
      {/* ════════════════ HEADER SECTION ════════════════ */}
      <table cellPadding="0" cellSpacing="0" width="100%" style={{ marginBottom: "48px", tableLayout: "fixed" }}>
        <tr>
          <td style={{ wordBreak: "break-word" as const, overflowWrap: "break-word" as const }}>
            {/* Eyebrow */}
            ...
            <>
              ...
              {myItems.map((item, i) => (
                <table key={i} cellPadding="0" cellSpacing="0" width="100%" style={{
                  backgroundColor: "#ffffff", border: "1px solid #eceeef",
                  borderRadius: "12px", marginBottom: "6px", tableLayout: "fixed",
                }}>
                  <tr>
                    <td style={{ padding: "20px 24px", width: "64px", verticalAlign: "middle" }}>
                      <div style={{ width: "40px", height: "40px", borderRadius: "8px", backgroundColor: "#cbdafd" }} />
                    </td>
                    <td style={{ padding: "20px 0", verticalAlign: "middle", wordBreak: "break-word" as const, overflowWrap: "break-word" as const }}>
                    ...
                    <td style={{ padding: "20px 24px", width: "140px", textAlign: "right", verticalAlign: "middle" }}>
                      {item.dueLabel && (
                        <p style={{ fontFamily: F.inter, fontSize: "13px", fontWeight: 600, color: "#29407d", margin: "0", whiteSpace: "nowrap" }}>
                          {item.dueLabel}
                        </p>
                      )}
                    </td>
              ...
              {otherItems.map((item, i) => (
                <table key={i} cellPadding="0" cellSpacing="0" width="100%" style={{
                  ...
                  <tr>
                    ...
                    <td style={{ padding: "20px 0", paddingRight: "24px", verticalAlign: "middle", wordBreak: "break-word" as const, overflowWrap: "break-word" as const }}>
                      <p style={{ fontFamily: F.manrope, fontSize: "15px", fontWeight: 700, color: "#191c1d", margin: "0 0 2px 0" }}>
                        {item.title}
                      </p>
                      <p style={{ fontFamily: F.inter, fontSize: "11px", color: "#757684", textTransform: "uppercase", letterSpacing: "0.1em", margin: "0" }}>
