    ...
    <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          ...
          <div className="flex gap-3">
            <button className="px-5 py-2.5 bg-muted text-foreground font-semibold rounded-xl hover:bg-accent transition-colors flex items-center gap-2">
              <Share2 className="h-4 w-4" /> {t("editorial.share")}
            </button>
          </div>
        </div>
      </section>
      ...
      <div className="grid grid-cols-12 gap-6 mb-10">
              ...
              {aiSummary.overallSentiment && (
                <div className="bg-accent rounded-xl p-6">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest">{t("editorial.sentimentLabel")}</span>
                  </div>
        ...
        <div className="col-span-12 lg:col-span-4 space-y-4">
          ...
          {/* Category Highlights */}
          <h3 className="text-xs font-bold text-muted-foreground uppercase tracking-widest px-2">{t("editorial.categoryHighlights")}</h3>
      ...
      <section className="mb-10">
        <h3 className="text-xl font-bold text-foreground mb-6 px-2 font-headline">{t("editorial.detailedResponses")}</h3>
      ...
      <section className="mb-10 grid grid-cols-1 md:grid-cols-2 gap-10">
        <div>
          ...
          <div className="space-y-3">
            ...
            {allActionItems.length === 0 && <p className="text-sm text-muted-foreground italic px-2">{t("editorial.noActionItems")}</p>}
          </div>
        </div>
