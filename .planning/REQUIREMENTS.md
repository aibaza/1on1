...
- [x] **DES-01**: All primary CTA buttons use a single consistent color across auth pages and app pages — choose monochrome (recommended) or orange and apply globally
...
- [x] **MOB-02**: Template detail action bar fits within mobile viewport — overflow menu for secondary actions
...
- [x] **MOB-05**: Audit log table is readable on mobile — card-based row layout or priority columns
